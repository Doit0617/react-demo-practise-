...
var mysql_1 = require("../common/mysql");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, RegisterUesr(userName, userPwd)];
            case 1:
                ans = _a.sent();
                ctx.body = ans;
                return [2 /*return*/];
...
function RegisterUesr(userName, userPwd) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, params, a;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = "INSERT INTO users(username,passsword) values(?,?)";
                    params = [userName, userPwd];
                    return [4 /*yield*/, (0, mysql_1.query)(sql, params)];
                case 1:
                    a = _a.sent();
                    return [2 /*return*/, a];
            }
